...
description: "Identifies security vulnerabilities in code and AWS infrastructure. Generates audit reports with severity ratings and remediation. Invoke for SAST scans, Terraform security review (Checkov/tfsec), IAM policy audit, secrets scanning, AWS Security Hub findings, container image scanning, or compliance checks."
allowed-tools: Read, Grep, Glob, Bash
metadata:
  domain: security
  triggers: security review, vulnerability scan, SAST, security audit, penetration test, Checkov, tfsec, IAM audit, AWS Security Hub, GuardDuty, secrets scanning, container scanning, trivy, compliance
  role: specialist
  scope: review
