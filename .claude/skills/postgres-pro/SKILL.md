---
name: postgres-pro
description: "Use when optimizing PostgreSQL/Aurora PostgreSQL queries, configuring replication, or implementing advanced database features. Invoke for EXPLAIN analysis, Aurora Global Database, Secrets Manager credential rotation, JSONB operations, VACUUM tuning, performance monitoring."
metadata:
  domain: infrastructure
  triggers: PostgreSQL, Postgres, Aurora PostgreSQL, EXPLAIN ANALYZE, pg_stat, JSONB, streaming replication, logical replication, VACUUM, Global Database, Secrets Manager, RDS
  role: specialist
